...
export const FadeAnimation = observer((props: { animation: FadeInAnimation | FadeOutAnimation }) => {
    const store = React.useContext(StoreContext)
    return (
...
export const SlideAnimation = observer((props: { animation: SlideInAnimation | SlideOutAnimation }) => {
    const store = React.useContext(StoreContext)
    return (
        <div className="flex flex-col w-full items-start">
            {/* duration */}
