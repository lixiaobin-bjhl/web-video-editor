        ...
        <>
            ...
            <div className="px-[16px]">
                <div className="flex flex-row items-center my-2">
                    <div className="text-xs font-semibold mr-2">视频时长:</div>
                    <input
                        type="number"
            ...
            <div className="px-[16px]">
                <div className="text-xs font-semibold mr-2">视频格式:</div>
                <div className="flex flex-row items-center my-2">
                    <input
                        type="radio"
                        className="mr-2"
            ...
            >
                导出视频 ({store.maxTime / 1000} secs) {store.selectedVideoFormat === "mp4" ? ("ALPHA") : ""}
            </button>
        </>
    );
});
